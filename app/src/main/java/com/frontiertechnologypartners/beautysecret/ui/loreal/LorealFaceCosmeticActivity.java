...
public class LorealFaceCosmeticActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loreal_face_cosmetic);
        ...
        product1Layout.setOnClickListener(v -> {
            Intent intent = new Intent(LorealFaceCosmeticActivity.this, ProductsActivity.class);
            intent.putExtra(PRODUCT_TYPE, 17);
            startActivity(intent);
        });

        product2Layout.setOnClickListener(v -> {
            Intent intent = new Intent(LorealFaceCosmeticActivity.this, ProductsActivity.class);
            intent.putExtra(PRODUCT_TYPE, 18);
            startActivity(intent);
        });

        product3Layout.setOnClickListener(v -> {
            Intent intent = new Intent(LorealFaceCosmeticActivity.this, ProductsActivity.class);
            intent.putExtra(PRODUCT_TYPE, 19);
            startActivity(intent);
        });

        product4Layout.setOnClickListener(v -> {
            Intent intent = new Intent(LorealFaceCosmeticActivity.this, ProductsActivity.class);
            intent.putExtra(PRODUCT_TYPE, 20);
            startActivity(intent);
        });
    }
