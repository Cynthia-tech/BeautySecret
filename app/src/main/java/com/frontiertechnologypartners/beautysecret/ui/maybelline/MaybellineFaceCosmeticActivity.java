...
public class MaybellineFaceCosmeticActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maybelline_face_cosmetic);
        ...
        product1Layout.setOnClickListener(v -> {
            Intent intent = new Intent(MaybellineFaceCosmeticActivity.this, ProductsActivity.class);
        ...
        product4Layout.setOnClickListener(v -> {
            Intent intent = new Intent(MaybellineFaceCosmeticActivity.this, ProductsActivity.class);
            intent.putExtra(PRODUCT_TYPE, 8);
            startActivity(intent);
        });
    }
